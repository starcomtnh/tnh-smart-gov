...
public class PhoneWithFieldNameValidator implements ConstraintValidator<PhoneWithFieldName, String> {

    final MessageService messageService;
    String fieldName;

    @Override
    public void initialize(PhoneWithFieldName constraintAnnotation) {
